      ...
      <div className="mt-12">
        ...
        <div className=" flex flex-col items-center mt-20">
          <div className=" flex-col items-center w-max">
            <p className=" text-3xl font-medium">Related Proudcts</p>
            <div className=" w-20 h-0.5 bg-primary rounded-full mt-2"></div>
          </div>
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols- lg:grid-cols-5 gap-3 md:gap-6 mt-6 w-full">
            {relatedProducts
